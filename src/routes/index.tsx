...
function GatePage() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "linear-gradient(to bottom, color-mix(in oklab, black 55%, transparent), color-mix(in oklab, black 75%, transparent)), url('https://prophotoskills.github.io/pps-assets/images/TitelNextLevel_kk.jpg')",
      }}
    >
