...
function LoginPage() {
  ...
  return (
    ...
    >
      <div className="flex w-full max-w-5xl flex-col items-stretch justify-center gap-6 md:flex-row md:items-stretch">
      <Card className="flex w-full flex-col md:w-1/3 shadow-xl backdrop-blur-sm">
